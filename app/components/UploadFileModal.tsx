        ...
        <Modal.Dialog>
          ...
          <Modal.Header>
            ...
            <p className='text-sm leading-5 text-muted'>
              PDF akan diproses menjadi chunks dan embedding, lalu disimpan di SingleStore.
            </p>
          </Modal.Header>
          <Modal.Body>
          ...
          <Modal.Footer>
            <Button slot='close' isDisabled={isUploading} variant='secondary' onPress={onCancel}>
              Batal
            </Button>
