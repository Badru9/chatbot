      ...
      <div className="w-full max-w-3xl flex flex-col gap-6 mt-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Kelola Menu Portal</h1>
          </div>
        </div>
        <div className="p-12 border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 rounded-2xl flex flex-col items-center justify-center gap-4 text-center">
          ...
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">Panel Admin: Pengelolaan Menu</h2>
          <p className="text-neutral-400 max-w-sm text-sm">
            Halaman khusus admin untuk memodifikasi, menambah, atau mengurutkan navigasi card menu yang tampil di dashboard.
          </p>
        </div>
      </div>
    </PortalLayout>
