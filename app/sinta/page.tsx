      ...
      <div className="w-full max-w-3xl flex flex-col gap-6 mt-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Portal SINTA</h1>
          </div>
        </div>
        <div className="p-12 border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 rounded-2xl flex flex-col items-center justify-center gap-4 text-center">
          <TrendUp size={48} className="text-neutral-300 dark:text-neutral-700" />
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">Fitur Integrasi SINTA Sedang Dikembangkan</h2>
          <p className="text-neutral-400 max-w-sm text-sm">
            Halaman ini nantinya akan menyinkronkan data publikasi, kekayaan intelektual, dan H-index dari akun SINTA dosen secara terpadu.
          </p>
        </div>
      </div>
    </PortalLayout>
