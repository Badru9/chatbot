...
export const chatSchema = z.object({
  ...
  messages: z
    ...
    .optional(),
  activeTools: z.array(z.string().max(50)).max(10).optional(),
...
export const chatContextSchema = z.object({
  ...
  documentIds: z.array(z.string().max(256)).max(20).optional(),
...
export const datasetSchema = z.object({
  name: z
    ...
    .max(255, "Nama maks 255 karakter"),
  description: z.string().max(1000, "Deskripsi maks 1.000 karakter").optional(),
  content: z
    .string()
    .min(1, "Konten dataset wajib diisi")
    .max(500000, "Konten maks 500.000 karakter"),
  source: z.string().max(500).optional(),
